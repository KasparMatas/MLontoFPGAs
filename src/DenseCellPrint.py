class DenseCellPrinter:
  ...
  def printWires(self, output_wire_names, output_file):
    ...
    output_file.write("wire [`DATA_WIDTH:0] {};\n".format(output_wire_names[2]))
  ...
  def formatWeights(self, weights):
    ...
    for weight in weights:
      weightString += "32'd{}, ".format(weight)
  ...
  def printIndividualCell(self, weights, unit_index, layer_index, input_wire_names, output_wire_names, output_file):
  ...
  def printCells(self, weights, layer_index, amount_of_units_in_a_layer, input_wire_names, output_file):
    for unit_index in range (amount_of_units_in_a_layer):
      ...
      output_file.write("\n")
      self.printIndividualCell(weights, unit_index, layer_index, input_wire_names, output_wire_names, output_file)
